  ...
  useEffect(() => {
    getCustomer(id).then((found) => {
      ...
      if (found) {
        ...
        setOpeningBalance((found.opening_balance_cents / 100).toString());
        setCreditLimit(
          found.credit_limit_cents !== undefined
            ? (found.credit_limit_cents / 100).toString()
            : "",
        );
        setAddress(found.address ?? "");
        setRoyaltyEligible(found.royalty_eligible);
      }
    });
  }, [id]);
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      await updateCustomer(id, {
        ...
        opening_balance_cents: openingBalance.trim()
      ...
      showToast(`${firstName.trim()} ${lastName.trim()} updated`, "success");
