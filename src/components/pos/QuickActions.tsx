      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        {actions.map((action) => (
          <button
            ...
            className={`flex w-20 flex-col items-center gap-1 rounded-lg border border-zinc-200 px-2 py-2 text-[11px] font-medium transition-colors hover:bg-zinc-50 disabled:opacity-40 dark:border-zinc-800 dark:hover:bg-zinc-800 ${
              action.danger
